[Hit(uuid='0',
     ...
     text='# 🦜️🔗 LangChain\n'
          ...
          'Please fill out [this form](https://forms.gle/57d8AmXBYp8PP8tZA) '
          "and we'll set up a dedicated support Slack channel.\n"
          '\n'
          '## Quick Install\n'
          '\n'
          ...
          'technology, enabling developers to build applications that they '
          'previously could not. However, using these LLMs in isolation is '
          'often insufficient for creating a truly powerful app - the real '
          'power comes when you can combine them with other sources of '
          'computation or knowledge.\n'
          '\n'
          'This library aims to assist in the development of those types of '
          'applications. Common examples of these applications include:\n'
          '\n'
          ...
          '## 📖 Documentation\n'
          '\n'
          'Please see [here](https://langchain.readthedocs.io/en/latest/?) for '
          ...
          'interface for all LLMs, and common utilities for working with '
          'LLMs.\n'
          '\n'
          '**🔗 Chains:**\n'
          '\n'
          'Chains go beyond a single LLM call and involve sequences of calls '
          '(whether to an LLM or a different utility). LangChain provides a '
          'standard interface for chains, lots of integrations with other '
          'tools, and end-to-end chains for common applications.\n'
          '\n'
          '**📚 Data Augmented Generation:**\n'
          '\n'
          'Data Augmented Generation involves specific types of chains that '
          'first interact with an external data source to fetch data for use '
          'in the generation step. Examples include summarization of long '
          ...
          'done. LangChain provides a standard interface for agents, a '
          'selection of agents to choose from, and examples of end-to-end '
          'agents.\n'
          '\n'
          '**🧠 Memory:**\n'
          '\n'
          'Memory refers to persisting state between calls of a chain/agent. '
          'LangChain provides a standard interface for memory, a collection of '
          'memory implementations, and examples of chains/agents that use '
          'memory.\n'
          '\n'
          '**🧐 Evaluation:**\n'
          '\n'
          ...
          'language models themselves to do the evaluation. LangChain provides '
          'some prompts/chains for assisting in this.\n'
          '\n'
          ...
          'feature, improved infrastructure, or better documentation.\n'
          '\n'
