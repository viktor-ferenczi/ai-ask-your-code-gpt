[Sentence(lineno=1,
 ...
 Sentence(lineno=17,
          ...
          text='[![Open '
               ...
               "production, we'd love to offer more comprehensive support.\n"
 ...
 Sentence(lineno=25,
          ...
          text='## Quick Install\n'
               ...
               'technology, enabling developers to build applications that '
               'they previously could not. However, using these LLMs in '
               'isolation is often insufficient for creating a truly powerful '
               'app - the real power comes when you can combine them with '
               'other sources of computation or knowledge.\n'
               '\n'
               'This library aims to assist in the development of those types '
               'of applications. Common examples of these applications '
               'include:\n'
               '\n'
 ...
 Sentence(lineno=38,
          ...
          text='\n'
               ...
               'Database](https://github.com/hwchase17/notion-qa)\n'
               '\n'
               '**💬 Chatbots**\n'
               '\n'
               '- '
 ...
 Sentence(lineno=52,
          ...
          text='## 📖 Documentation\n'
               '\n'
               'Please see '
               '[here](https://langchain.readthedocs.io/en/latest/?) for full '
               'documentation on:\n'
               '\n'
               ...
               '\n'
               'There are six main areas that LangChain is designed to help '
               'with.\n'
               'These are, in increasing order of complexity:\n'
               '\n'
               '**📃 LLMs and Prompts:**\n'
               '\n'
               'This includes prompt management, prompt optimization, a '
               'generic interface for all LLMs, and common utilities for '
               'working with LLMs.\n',
          start=3488),
 Sentence(lineno=69,
          length=127,
          ...
          text='\n'
               '**🔗 Chains:**\n'
               '\n'
               'Chains go beyond a single LLM call and involve sequences of '
               'calls (whether to an LLM or a different utility). LangChain '
               'provides a standard interface for chains, lots of integrations '
               'with other tools, and end-to-end chains for common '
               'applications.\n'
               '\n'
               '**📚 Data Augmented Generation:**\n'
               '\n'
               'Data Augmented Generation involves specific types of chains '
               'that first interact with an external data source to fetch data '
               'for use in the generation step. Examples include summarization '
               'of long pieces of text and question/answering over specific '
               'data sources.\n'
               '\n'
               '**🤖 Agents:**\n',
          start=4120),
 Sentence(lineno=79,
          ...
          text='\n'
               ...
               'that until done. LangChain provides a standard interface for '
               'agents, a selection of agents to choose from, and examples of '
               'end-to-end agents.\n'
               '\n'
               '**🧠 Memory:**\n'
               '\n'
               'Memory refers to persisting state between calls of a '
               'chain/agent. LangChain provides a standard interface for '
               'memory, a collection of memory implementations, and examples '
               'of chains/agents that use memory.\n'
               '\n'
               '**🧐 Evaluation:**\n',
          start=4694),
 Sentence(lineno=87,
          ...
          text='\n'
               ...
               'language models themselves to do the evaluation. LangChain '
               'provides some prompts/chains for assisting in this.\n'
               '\n'
               'For more information on these concepts, please see our [full '
 ...
 Sentence(lineno=92,
          ...
          text='## 💁 Contributing\n'
               ...
               'are extremely open to contributions, whether it be in the form '
               'of a new feature, improved infrastructure, or better '
               'documentation.\n'
               '\n'
