...
''',
        ...
        query_embeddings: np.ndarray = embedding.embed_query('class GMLExporter')
        ...
        query_embeddings: np.ndarray = embedding.embed_query('.py class SomeOtherClass')
        similarities: np.ndarray = cosine_similarity(query_embeddings, fragment_embeddings)
        print(similarities)
        fragment_index = np.argmax(similarities)
        ...
        query_embeddings: np.ndarray = embedding.embed_query('completely_different method')
        similarities: np.ndarray = cosine_similarity(query_embeddings, fragment_embeddings)
        print(similarities)
